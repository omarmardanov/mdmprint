/* Скрипты лендинга 3D-стикеров. Подключается в конце body, DOM уже разобран.
  ...
  const LEGAL = {
    ...
    /* ВАЖНО, проверено 05.08: страница /terms озаглавлена «Пользовательское соглашение»,
       но единственный документ на ней — «Политика в отношении обработки персональных данных».
       То есть политика У НИХ ЕСТЬ, просто лежит по неочевидному адресу. Ссылаемся на неё
       как на политику — по содержанию, а не по заголовку страницы. */
    privacy: 'https://mdmprint.ru/terms',
    terms:   '',   // отдельного пользовательского соглашения по факту нет
